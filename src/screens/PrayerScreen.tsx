...
import { isPrayerCompletionOnTime } from "@/services/prayerCompletion";
...
export function PrayerScreen(): React.JSX.Element {
  ...
  const completeGuidedPrayer = () => {
    ...
    if (
      !isPrayerCompletionOnTime(params.completionDeadline, completedAt)
    ) {
      setGuidedPrayerOpen(false);
      Alert.alert(
        "Prayer time has passed",
        "This prayer was not added to your history or daily practice.",
      );
      return;
    }
