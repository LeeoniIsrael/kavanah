...
const reviewSeeds: Record<string, ReviewSeed> = {
  ...
  mezonot: complete("common", "Siddur Ashkenaz", "Berachot, Birkat Hanehenin, Brachot Rishonot, Mezonot"),
  hagafen: complete("common", "Siddur Ashkenaz", "Berachot, Birkat Hanehenin, Brachot Rishonot, HaGafen"),
  haetz: complete("common", "Siddur Ashkenaz", "Berachot, Birkat Hanehenin, Brachot Rishonot, HaEtz"),
  haadamah: complete("common", "Siddur Ashkenaz", "Berachot, Birkat Hanehenin, Brachot Rishonot, HaAdamah"),
  shehakol: complete("common", "Siddur Ashkenaz", "Berachot, Birkat Hanehenin, Brachot Rishonot, Shehakol"),
  ...
  "al-hamichya": excerpt("ashkenaz", "Siddur Ashkenaz", "Berachot, Birkat Hanehenin, Brachot Achronot, Al Hamichya", "Opening clause only; full wording varies with tradition and occasion."),
  "al-hagefen": excerpt("ashkenaz", "Siddur Ashkenaz", "Berachot, Birkat Hanehenin, Brachot Achronot, Al Hagefen", "Opening clause only; full wording varies with tradition and occasion."),
  "al-haetz": excerpt("ashkenaz", "Siddur Ashkenaz", "Berachot, Birkat Hanehenin, Brachot Achronot, Al HaEtz", "Opening clause only; full wording varies with tradition and occasion."),
