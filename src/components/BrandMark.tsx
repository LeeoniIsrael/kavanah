...
export function BrandMark({ size = 44, inverted = false }: { size?: number; inverted?: boolean }): React.JSX.Element {
...
export function BrandWordmark({ width = 152, inverted = false }: { width?: number; inverted?: boolean }): React.JSX.Element {
